...
$goodad = if(!($ad -eq $Table1)) { Write-Output "Check the  ADGroups.csv, contents of file do not match table" }
$good0365 = if(!($o365 -eq $Table2)) { Write-Output "Check the O365Groups.csv, contents of file do not match table" }
