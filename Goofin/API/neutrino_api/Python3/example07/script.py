...
# python3 /path/to/script.py "https://www.google.com/" "/tmp/screenshot.png"
...
def apivoid_screenshot_url(key, url):
   try:
      r = requests.get(url='https://endpoint.apivoid.com/screenshot/v1/pay-as-you-go/?key='+key+'&url='+urllib.parse.quote(url))
      return json.loads(r.content.decode())
   except:
      return ""

data = apivoid_screenshot_url(apivoid_key, url)
